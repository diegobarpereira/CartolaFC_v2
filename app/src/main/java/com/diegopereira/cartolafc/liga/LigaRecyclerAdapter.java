...
public class LigaRecyclerAdapter extends RecyclerView.Adapter<LigaRecyclerAdapter.ViewHolder> {
    ...
    public LigaRecyclerAdapter(Context context, List<Atleta> list, Integer capitao, Map<Integer, Posicoes> posicoes, Map<Integer, Clubes> clubes) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private AppCompatTextView tv_jogador, tv_posicao, tv_pontos;
