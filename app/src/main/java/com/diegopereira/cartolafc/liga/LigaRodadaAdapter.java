...
public class LigaRodadaAdapter extends RecyclerView.Adapter<LigaRodadaAdapter.ViewHolder> {
    ...
    public LigaRodadaAdapter(Context context, List<Atleta> list, Integer capitao, Integer idgol, Integer idlat,
                               Integer idzag, Integer idmei, Integer idata, Integer idtec,  Map<String, Double> mapparciais, Map<String, Double> mapliga) {
